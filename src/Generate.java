...
public class Generate {
    ...
    // any command line argument sets this to true
    ...
    static long init() throws Exception {
        ...
        points = new int[nrIn + nrOut + nrStaticTraps + nrDynamicTraps + nrKeys][2];
    ...
    public static void generate(int width, int height, int nrIn, int nrOut, int nrKeys, int nrStaticTraps, int nrDynamicTraps) {
        try {
            prop = new Properties();
            ...
            Generate.nrIn = nrIn;
            Generate.nrOut = nrOut;
            Generate.nrKeys = nrKeys;
            Generate.nrStaticTraps = nrStaticTraps;
            Generate.nrDynamicTraps = nrDynamicTraps;
